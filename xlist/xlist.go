...
// lazyInit is lazily initializes a zero List[T] value.
...
// insert is inserts e after at, increments l.len, and returns e.
...
// remove is removes e from its list, decrements l.len
